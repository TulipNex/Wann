...
let handler = async (m, { conn, text }) => {
  ...
  // conn.chatRead(m.chat) <- Dihapus karena menyebabkan Error "TypeError: conn.sendReadReceipt is not a function"
  ...
  // Menggunakan contextInfo persis seperti format tagme untuk memaksa tag menjadi biru
